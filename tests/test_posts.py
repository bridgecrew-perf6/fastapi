...
def test_get_all_posts(authorized_client, test_posts):
    ...
    assert res.status_code == 201  # changed
...
def test_get_one_post_404(authorized_client, test_posts):
    res = authorized_client.get("/posts/888888734")
...
def test_delete_post_not_exist(authorized_client, test_user, test_posts):
    res = authorized_client.delete(f"/posts/673632222")
    assert res.status_code == 404
...
def test_update_post_not_exist(authorized_client, test_user, test_posts):
    ...
    res = authorized_client.put(f"/posts/673632222", json=data)
    assert res.status_code == 404
